        ...
        <asp:GridView ID="GridView1" runat="server" CssClass="mydatagrid" PagerStyle-CssClass="pager" AutoGenerateColumns="false" DataKeyNames="task_id" OnRowCancelingEdit="GridView1_RowCancelingEdit"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Phone Number">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label9" runat="server" Text='<%# Eval("phone_no") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Role Type">
                    <ItemStyle Width="120px" />
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("roleType") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Account Status">
                    <ItemStyle Width="120px" />
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("account_status") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
