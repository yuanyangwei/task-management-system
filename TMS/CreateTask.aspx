    ...
    <div>
        <fieldset style="width: 100%;">
            ...
            <asp:Table ID="Table1" runat="server" Height="126px" Width="1067px" Style="margin-top: 0">
                ...
                <asp:TableRow runat="server">
                    <asp:TableCell>Task Comment:</asp:TableCell>
                    <asp:TableCell>
                        <asp:TextBox ID="txtComment" runat="server" Style="width: 300px" TextMode="MultiLine" />
                    </asp:TableCell>
                    <asp:TableCell>Task Description: </asp:TableCell>
                    <asp:TableCell>
                ...
                <asp:TableRow runat="server">
                    ...
                    <asp:TableCell>
                        <asp:TextBox ID="txtTaskStatus" runat="server" Style="width: 300px" Text="Pending" Enabled="False" />
                    </asp:TableCell>
                ...
                <asp:TableRow ID ="AssigneeRow" runat="server">
                    <asp:TableCell>Assignee:</asp:TableCell>
                    <asp:TableCell>
