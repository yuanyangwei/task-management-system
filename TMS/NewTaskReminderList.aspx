<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="NewTaskReminderList.aspx.cs" Inherits="TMS.NewTaskReminderList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <h3>You have <%:Session["NewTaskCount"]%> New Task</h3>
